...
<aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
    <section class="sidebar">
        <div class="" style="padding: 5px 50px; background-color: #0d4ab1!important; margin-bottom: -10px">
            <div class="w-80px mt-3 mb-3 ml-3"><a href="index-2.html"><h3 class="white-text" style="font-weight: bold">MonTPWeb</h3></a></div>
        </div>
        <div class="relative">
            ...
            <div class="user-panel p-3 light mb-2">
                <div>
                    ...
                    <div class="float-left info">
                        <h6 class="font-weight-light mt-2 mb-1">User Connecté</h6>
                ...
                <div class="collapse multi-collapse" id="userSettingsCollapse">
                    <div class="list-group mt-3 shadow">
                        <a href="index-2.html" class="list-group-item list-group-item-action "><i class="mr-2 icon-umbrella text-blue"></i>Profil</a>
                        <a href="#" class="list-group-item list-group-item-action"><i class="mr-2 icon-security text-purple"></i>Mot de Passe</a>
                        <a href="#" class="list-group-item list-group-item-action"><i class="mr-2 icon-cogs text-yellow"></i>Déconnexion</a>
                    </div>
                </div>
            </div>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="treeview open active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="form-jquery-validations.html"><i class="icon icon-note-important light-green-text"></i>
