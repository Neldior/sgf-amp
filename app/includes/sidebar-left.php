...
<aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
    <section class="sidebar">
            ...
            <div class="user-panel p-3 light mb-2">
                <div>
                    <div class="float-left image">
                        <img class="user_avatar" src="../../assets/img/dummy/<?= $avataruser ?>" alt="User Image">
                    </div>
                ...
                <div class="collapse multi-collapse" id="userSettingsCollapse">
                    <div class="list-group mt-3 shadow">
                        <a href="../../../app/web/contents/employe-profil.page.php" class="list-group-item list-group-item-action "><i class="mr-2 icon-umbrella text-blue"></i>Profil</a>
                        <a href="../../../app/web/contents/employe-pass.page.php" class="list-group-item list-group-item-action"><i class="mr-2 icon-security text-purple"></i>Mot de Passe</a>
        ...
        <ul class="sidebar-menu text-black" style="font-weight: bold; font-size: 14px">
            ...
            <li class="treeview"><a href="../../../app/web/contents/dmde-avance-new.page.php"><i class="icon icon icon-package blue-text s-18"></i> <span class="text-black">Demander une avance</span></a></li>
            <li class="treeview"><a href="../../../app/web/contents/dmde-rmbsmt-new.page.php"><i class="icon icon icon-package blue-text s-18"></i> <span class="text-black">Demander un remboursement</span></a></li>
            ...
            <li class="treeview"><a href="#"><i class="icon icon-sailing-boat-water purple-text s-18"></i> <span class="text-black">Gestion des Demandes</span> <i class="icon icon-angle-left s-18 pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class=""><a href="../../../app/web/contents/dmde-avance-liste.page.php"><i class="icon icon-folder5"></i>Demandes d'Avance</a></li>
                    <li class=""><a href="../../../app/web/contents/dmde-rmbsmt-liste.page.php"><i class="icon icon-folder5"></i>Demandes de Remboursement</a></li>
                </ul>
            </li>
            <?php if($isAdmin) { ?>
            ...
            <li class="treeview"><a href="#"><i class="icon icon-account_box light-green-text s-18"></i><span class="text-black">Administration</span><i class="icon icon-angle-left s-18 pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="../../app/web/contents/profils-liste.page.php"><i class="icon icon-profile-1"></i>Gestion des Profils</a></li>
                    <li><a href="../../../app/web/contents/users-liste.page.php"><i class="icon icon-user"></i>Gestion des Utilisateurs</a></li>
