            ...
            <div class="page has-sidebar-left bg-light height-full">
                <header class="blue accent-3 relative nav-sticky"> <!-- style="background-color: #09709f !important;"-->
                    <div class="container-fluid text-white">
                        <div class="row">
                            <div class="col">
                                <h3 class="my-3"><i class="icon icon-note-important"></i> <strong>Gestion des Profils des Employés</strong></h3>
                            </div>
                        </div>
                    </div>
                </header>
...
<!--                                        <div class="col-sm-1 text-right" style="margin-top: 5px;">
                                        ...
                                        <div class="col-sm-7 text-left">
                                            <strong>
                                                <select class="custom-select select2 text-center" id="profil" onchange="" style="font-weight: bold; font-size: 16px">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="center-text" style="text-align: center !important;">
                                                    <a href="#" class="btn-fab shadow btn-primary" title="Modifier" onclick="return fnLoadScreenUser('modif','1');"><i class="s-24 icon-pencil"></i></a>
